    ...
    return (
      <div className="relative flex items-center w-full min-w-0">
        ...
        <input
          ...
          ref={ref}
          className={cn(
            "w-full bg-surface/80 text-cream placeholder:text-sage/70 rounded-2xl border border-surface-border px-5 py-3.5 text-base transition-colors duration-200",
